...
@Tag(name = "Tarefas", description = "Cadastra tarefas de usuários") // isso vem do swagger
...
public class TarefasController {
    ...
    @GetMapping("/eventos")
    @Operation(summary = "Busca Tarefas por Período", description = "Busca uma lista de tarefas por período")
    ...
    @GetMapping
    @Operation(summary = "Busca Lista de Tarefas por Email de Usuário", description = "Busca as tarefas cadastradas por cada email de usuário")
    @ApiResponse(responseCode = "200", description = "Tarefa encontrada")
    @ApiResponse(responseCode = "500", description = "Erro de servidor")
    ...
    @PutMapping
    @Operation(summary = "Altera Dados da Tarefas", description = "altera dados das tarefas cadastradas")
    @ApiResponse(responseCode = "200", description = "Tarefas alteradas")
    @ApiResponse(responseCode = "500", description = "Erro de servidor")
